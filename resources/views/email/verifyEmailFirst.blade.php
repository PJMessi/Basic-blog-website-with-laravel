...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <div class="container">
        <p>
            An email has just been sent to your email address with a link.
            Please open that link to activate your account.</p>
            
            <p>After that, <a href="/dashboard">click here</a> to log in.<p>
        </p>
        </div>
        <!---->
